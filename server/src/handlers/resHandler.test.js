...
const { restaurantHandler, updateHandler, restaurantMenuHandler } = await import('./resHandler.js');
const { getRestaurantData, getUpdatedData, getRestaurantMenu } = await import('../helpers/resHelper.js');

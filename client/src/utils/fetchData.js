...
const fetchWhatsOnMindUpdateData = async ({ lat, lng, collection_id, tags, type, count }) => {
    const url = API_URL + '/update'
    const body = {
        "lat": lat,
        "lng": lng,
...
export { fetchData, fetchUpdateData, fetchRestaurantMenu, fetchWhatsOnMindRestaurants, fetchWhatsOnMindUpdateData }

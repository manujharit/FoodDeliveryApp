    ...
    <div className="about">
      ...
      <ul className="about__list">
        <li className="about__list-item">
          <b className="about__highlight">Frontend:</b> <span className="about__text--inline">ReactJS</span>
        </li>
        <li className="about__list-item">
          <b className="about__highlight">Backend:</b> <span className="about__text--inline">Node.js</span>
        </li>
        <li className="about__list-item">
          <b className="about__highlight">API Integration:</b> <span className="about__text--inline">Swiggy API</span>
        </li>
      </ul>
      ...
      <ul className="about__list">
        ...
        <li className="about__list-item">Add items to the cart to place orders.</li>
      </ul>

      <h2 className="about__subtitle">Architecture</h2>
      <p className="about__text">
        The application follows a client-server architecture with a separation of concerns between the frontend and
        backend components.
      </p>

      <h3 className="about__section-title">Frontend (ReactJS)</h3>
      <p className="about__text">
        The frontend is built using React, a popular JavaScript library for building user interfaces. It handles the
        rendering of the app&apos;s UI, user interactions, and communication with the backend via API calls.
      </p>

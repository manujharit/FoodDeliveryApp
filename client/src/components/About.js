...
const About = () => {
    return (
        <div className="my-[5%] mx-[13.5%] text-orange-400">
            ...
            <p>
                <br />
                <label className="text-3xl font-bold">Food Delivery App (<a href={SOURCE_CODE_URL} target="_blank" className="text-lg hover:underline px-2">View Source Code</a>)</label>
                <br />
                <br />
